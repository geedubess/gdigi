...
static EffectValues values_1_to_100 = {
    .min = 0.0, .max = 99.0,
    .type = VALUE_TYPE_OFFSET,
    .offset = 1,
};
...
static EffectValues values_m24_to_24 = {
    .min = 0.0, .max = 48.0,
    .type = VALUE_TYPE_OFFSET | VALUE_TYPE_SUFFIX,
    .offset = -24, .suffix = " semitones"
};
...
static Device rp150 = {
    .name = "DigiTech RP150",
    .family_id = RP150_FAMILY,
    .product_id = RP150_PRODUCT,
    .pages = rp150_pages,
...
static Device rp155 = {
    .name = "DigiTech RP155",
    .family_id = RP155_FAMILY,
    .product_id = RP155_PRODUCT,
    .pages = rp155_pages,
...
static Device rp250 = {
    .name = "DigiTech RP250",
    .family_id = RP250_FAMILY,
    .product_id = RP250_PRODUCT,
    .pages = rp250_pages,
...
static Device rp255 = {
    .name = "DigiTech RP255",
    .family_id = RP255_FAMILY,
    .product_id = RP255_PRODUCT,
    .pages = rp255_pages,
...
static Device rp355 = {
    .name = "DigiTech RP355",
    .family_id = RP355_FAMILY,
    .product_id = RP355_PRODUCT,
    .pages = rp355_pages,
...
static Device rp500 = {
    .name = "DigiTech RP500",
    .family_id = RP500_FAMILY,
    .product_id = RP500_PRODUCT,
    .pages = rp500_pages,
...
static Device rp1000 = {
    ...
    .family_id = RP1000_FAMILY,
    .product_id = RP1000_PRODUCT,
    .pages = rp1000_pages,
...
static Device gnx4 = {
    .name = "DigiTech GNX4",
    .family_id = GNX4_FAMILY,
    .product_id = GNX4_PRODUCT,
    .pages = gnx4_pages,
...
static Device gnx3000 = {
    ...
    .family_id = GNX3000_FAMILY,
    .product_id = GNX3000_PRODUCT,
    .pages = gnx3000_pages,
...
static Modifier modifiers[] = {
    ...
    {"Delay Tap Ratio", DELAY_TAP_RATIO, DELAY_POSITION, &values_1_to_100},
...
static XmlLabel xml_dist_labels[] = {
    ...
    {DIST_TYPE_MX, "MX Distortion"},
    {DIST_TYPE_DS, "DS Distortion"},
...
static XmlLabel xml_amp_labels[] = {
    ...
    {AMP_TYPE_LEGACY_VL100, "'99 Legacy VL-100"},
    ...
    {AMP_TYPE_PV5150II, "'02 PV 5150II"},
    {AMP_TYPE_RG100, "'89 RG100"},
    {AMP_TYPE_JC120_JAZZ, "JC-120 Jazz"},
    {AMP_TYPE_SOLAR100, "Solar 100"},
    {AMP_TYPE_SOLO, "Solo"},
    {AMP_TYPE_METAL, "Metal"},
    {AMP_TYPE_BRIGHT, "DigiTech\xc2\xae Bright Clean"},
...
static XmlLabel xml_chorusfx_labels[] = {
    ...
    {CHORUS_TYPE_PITCH_SHIFT, "Pitch Shift"},
...
static XmlLabel xml_delay_labels[] = {
    ...
    {DELAY_RP500_TYPE_ECHOPLEX, "EchoPlex"},
...
static XmlLabel xml_link_to_labels[] = {
    ...
    {LINK_TO_X(LFO1, LFO_SPEED),                     "LFO 1 Speed"},
    {LINK_TO_X(LFO2, LFO_SPEED),                     "LFO 2 Speed"},
...
XmlSettings xml_settings[] = {
    ...
    {DIST_TYPE, DIST_POSITION, "Distortion Type", &values_dist_type, xml_dist_labels, G_N_ELEMENTS(xml_dist_labels)},
    {DIST_ON_OFF, DIST_POSITION, "Distortion Enable", &values_on_off, xml_on_off_labels, G_N_ELEMENTS(xml_on_off_labels)},
    {DIST_SCREAMER_DRIVE, DIST_POSITION, "Distortion Drive", &values_0_to_99,},
    {DIST_SCREAMER_TONE, DIST_POSITION, "Distortion Tone", &values_0_to_99,},
    {DIST_SCREAMER_LVL, DIST_POSITION, "Distortion Level", &values_0_to_99,},
    {DIST_808_OVERDRIVE, DIST_POSITION, "Distortion Overdrive", &values_0_to_99,},
    {DIST_808_TONE, DIST_POSITION, "Distortion Tone", &values_0_to_99,},
    {DIST_808_LVL, DIST_POSITION, "Distortion Level", &values_0_to_99,},
    {DIST_GUYOD_DRIVE, DIST_POSITION, "Distortion Drive", &values_0_to_99,},
    {DIST_GUYOD_LVL, DIST_POSITION, "Distortion Level", &values_0_to_99,},
    {DIST_DOD250_GAIN, DIST_POSITION, "Distortion Gain", &values_0_to_99,},
    {DIST_DOD250_LVL, DIST_POSITION, "Distortion Level", &values_0_to_99,},
    {DIST_RODENT_DIST, DIST_POSITION, "Distortion Distortion", &values_0_to_99,},
    {DIST_RODENT_FILTER, DIST_POSITION, "Distortion Filter", &values_0_to_99,},
    {DIST_RODENT_LVL, DIST_POSITION, "Distortion Volume", &values_0_to_99,},
    {DIST_MX_DIST, DIST_POSITION, "Distortion Distortion", &values_0_to_99,},
    {DIST_MX_OUTPUT, DIST_POSITION, "Distortion Output", &values_0_to_99,},
    {DIST_DS_GAIN, DIST_POSITION, "Distortion Gain", &values_0_to_99,},
    {DIST_DS_TONE, DIST_POSITION, "Distortion Tone", &values_0_to_99,},
    {DIST_DS_LVL, DIST_POSITION, "Distortion Level", &values_0_to_99,},
    {DIST_GRUNGE_GRUNGE, DIST_POSITION, "Distortion Gain", &values_0_to_99,},
    {DIST_GRUNGE_FACE, DIST_POSITION, "Distortion Face", &values_0_to_99,},
    {DIST_GRUNGE_LOUD, DIST_POSITION, "Distortion Loud", &values_0_to_99,},
    {DIST_GRUNGE_BUTT, DIST_POSITION, "Distortion Butt", &values_0_to_99,},
    {DIST_ZONE_GAIN, DIST_POSITION, "Distortion Gain", &values_0_to_99,},
    {DIST_ZONE_MID_LVL, DIST_POSITION, "Distortion Mid Level", &values_0_to_99,},
    {DIST_ZONE_LEVEL, DIST_POSITION, "Distortion Level", &values_0_to_99,},
    {DIST_ZONE_LOW, DIST_POSITION, "Distortion Low", &values_0_to_99,},
    {DIST_ZONE_MID_FREQ, DIST_POSITION, "Distortion Mid Freq", &values_0_to_99,},
    {DIST_ZONE_HIGH, DIST_POSITION, "Distortion High", &values_0_to_99,},
    {DIST_DEATH_LOW, DIST_POSITION, "Distortion Low", &values_0_to_99,},
    {DIST_DEATH_MID, DIST_POSITION, "Distortion Mid", &values_0_to_99,},
    {DIST_DEATH_LVL, DIST_POSITION, "Distortion Level", &values_0_to_99,},
    {DIST_DEATH_HIGH, DIST_POSITION, "Distortion High", &values_0_to_99,},
    {DIST_GONK_GONK, DIST_POSITION, "Distortion Gunk", &values_0_to_99,},
    {DIST_GONK_SMEAR, DIST_POSITION, "Distortion Smear", &values_0_to_99,},
    {DIST_GONK_SUCK, DIST_POSITION, "Distortion Suck", &values_0_to_99,},
    {DIST_GONK_HEAVE, DIST_POSITION, "Distortion Heave", &values_0_to_99,},
    {DIST_FUZZY_FUZZ, DIST_POSITION, "Distortion Fuzz", &values_0_to_99,},
    {DIST_FUZZY_VOLUME, DIST_POSITION, "Distortion Volume", &values_0_to_99,},
    {DIST_MP_SUSTAIN, DIST_POSITION, "Distortion Sustain", &values_0_to_99,},
    {DIST_MP_TONE, DIST_POSITION, "Distortion Tone", &values_0_to_99,},
    {DIST_MP_VOLUME, DIST_POSITION, "Distortion Volume", &values_0_to_99,},
    ...
    {AMP_TYPE, AMP_A_POSITION, "Amp Type", &values_amp_type, xml_amp_labels, G_N_ELEMENTS(xml_amp_labels)},
    {AMP_ON_OFF, AMP_A_POSITION, "Amp Enable", &values_on_off, xml_on_off_labels, G_N_ELEMENTS(xml_on_off_labels)},
    {AMP_GAIN, AMP_A_POSITION, "Amp Gain", &values_0_to_99,},
    {AMP_LEVEL, AMP_A_POSITION, "Amp Level", &values_0_to_99,},
    ...
    {AMP_BASS, AMP_A_POSITION, "Amp Bass", &values_1_to_10_step_0p1,},
    {AMP_MID, AMP_A_POSITION, "Amp Mid", &values_1_to_10_step_0p1,},
    {AMP_TREBLE, AMP_A_POSITION, "Amp Treble", &values_1_to_10_step_0p1,},

    {AMP_CAB_TYPE, AMP_CAB_POSITION, "Cab Type", &values_cab_type, xml_amp_cab_labels, G_N_ELEMENTS(xml_amp_cab_labels)},
    ...
    {CHORUSFX_PRE_POST, CHORUSFX_POSITION, "Chorus/FX Position", &values_pre_post, xml_pre_post_labels, G_N_ELEMENTS(xml_pre_post_labels)},
    ...
    {DELAY_TAPE_FLUTTER, DELAY_POSITION, "Delay Tape Flutter", &values_0_to_99,},
    {DELAY_TAP_TIME_0_4990, DELAY_POSITION, "Delay Tap Time", &values_delay_time_0_4990,},
    {DELAY_TAP_TIME_0_760, DELAY_POSITION, "Delay Time", &values_delay_time_110_870,},
    ...
    {DELAY_TAP_RATIO, DELAY_POSITION, "Delay Tap Ratio", &values_1_to_100,},
    ...
    {WAH_PEDAL_POSITION, WAH_POSITION, "Wah Pedal", &values_0_to_99,},
    {WAH_LEVEL, WAH_POSITION, "Wah Level", &values_db_m6_to_12,},
    ...
    {VSWITCH_ENABLE, VSWITCH_ASSIGN_POSITION, "Toe Switch On Off", &values_on_off, xml_on_off_labels, G_N_ELEMENTS(xml_on_off_labels)},

    {LFO_TYPE, LFO1_POSITION, "LFO 1 Assign", &values_lfo_assign, xml_lfo_assign_labels, G_N_ELEMENTS(xml_lfo_assign_labels)},
    {LFO_MIN, LFO1_POSITION, "LFO 1 Min", &values_lfo_none,},
    {LFO_MAX, LFO1_POSITION, "LFO 1 Max", &values_lfo_none,},
    {LFO_SPEED, LFO1_POSITION, "LFO 1 Speed", &values_lfo_speed,},
    {LFO_WAVEFORM, LFO1_POSITION, "LFO 1 Waveform", &values_lfo_waveform, xml_waveform_labels, G_N_ELEMENTS(xml_waveform_labels)},

    {LFO_TYPE, LFO2_POSITION, "LFO 2 Assign", &values_lfo_assign, xml_lfo_assign_labels, G_N_ELEMENTS(xml_lfo_assign_labels)},
    {LFO_MIN, LFO2_POSITION, "LFO 2 Min", &values_lfo_none,},
    {LFO_MAX, LFO2_POSITION, "LFO 2 Max", &values_lfo_none,},
    {LFO_SPEED, LFO2_POSITION, "LFO 2 Speed", &values_lfo_speed,},
    {LFO_WAVEFORM, LFO2_POSITION, "LFO 2 Waveform", &values_lfo_waveform, xml_waveform_labels, G_N_ELEMENTS(xml_waveform_labels)},

    {EQ_ENABLE, EQ_A_POSITION, "EQ Enable", &values_on_off, xml_on_off_labels, G_N_ELEMENTS(xml_on_off_labels)},
    {EQ_TYPE, EQ_A_POSITION, "EQ Type", &values_eq_type, xml_eq_labels, G_N_ELEMENTS(xml_eq_labels)},
    ...
    // RP500 values
    {EQ_LOW_FREQ, EQ_A_POSITION, "EQ Low Freq", &values_eq_low_freq, xml_eq_low_freq_labels, G_N_ELEMENTS(xml_eq_low_freq_labels)},
    {EQ_MID_FREQ_RP500, EQ_A_POSITION, "EQ Mid Freq", &values_eq_mid_freq, xml_eq_mid_freq_labels, G_N_ELEMENTS(xml_eq_mid_freq_labels)},
    {EQ_HIGH_FREQ, EQ_A_POSITION, "EQ High Freq", &values_eq_high_freq, xml_eq_high_freq_labels, G_N_ELEMENTS(xml_eq_high_freq_labels)},

    {EQ_LOW_BANDWIDTH, EQ_A_POSITION, "EQ Low Bandwidth", &values_eq_bandwidth, xml_eq_bandwidth_labels, G_N_ELEMENTS(xml_eq_bandwidth_labels)},
    {EQ_MID_BANDWIDTH, EQ_A_POSITION, "EQ Mid Bandwidth", &values_eq_bandwidth, xml_eq_bandwidth_labels, G_N_ELEMENTS(xml_eq_bandwidth_labels)},
    {EQ_HIGH_BANDWIDTH, EQ_A_POSITION, "EQ High Bandwidth", &values_eq_bandwidth, xml_eq_bandwidth_labels, G_N_ELEMENTS(xml_eq_bandwidth_labels)},
    ...
    {TONE_LIB_TYPE, LIB_POSITION_A, "Tone Library Type", &values_tone_lib_type, xml_tone_lib_labels, G_N_ELEMENTS(xml_tone_lib_labels)},
    {FX_LIB_TYPE, LIB_POSITION_A, "Effects Library Type", &values_fx_lib_type, xml_fx_lib_labels, G_N_ELEMENTS(xml_fx_lib_labels)},
    {FX_LIB_LEVEL, LIB_POSITION_A, "Effects Level", &values_0_to_99,},
    {FX_LIB_LEVEL_MAX1, LIB_POSITION_A, "Effects Level Max 1", &values_0_to_99,},
    {FX_LIB_LEVEL_MAX2, LIB_POSITION_A, "Effects Level Max 2", &values_0_to_99,},
    {FX_LIB_LEVEL_MAX3, LIB_POSITION_A, "Effects Level Max 3", &values_0_to_99,},
